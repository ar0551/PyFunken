...
class PyFunken(object):
    ...
    def send_command(self, comm_txt, port, id_):
        '''
        ...
        Args:
            ...
            id (int): device ID
        '''
        self.ser_conn[port].ser.write(str.encode(comm_txt))
        time.sleep(self.wait)
    
    def get_response(self, comm_txt, token, port, id_):
        '''
